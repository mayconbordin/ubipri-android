...
public class Fixtures {
    ...
    public static Environment getEnvironment(int id) {
        Type listType = new TypeToken<ArrayList<Environment>>() {}.getType();
        List<Environment> environments = getGson().fromJson(ENVIRONMENTS_JSON, listType);
    ...
    public static List<Geofence> getEnvironmentsAsGeofencesFiltered(List<Integer> excluded) {
        List<Geofence> geofences = new ArrayList<>();

        for (Environment e : getEnvironments()) {
            if (!excluded.contains(e.getExtId())) {
                geofences.add(createGeofence(e));
            }
        }
    ...
    public static List<Geofence> getEnvironmentsAsGeofences() {
        List<Geofence> geofences = new ArrayList<>();
    ...
    public static Location createLocation(double lat, double lon) {
        Location l = new Location("mocked");
        l.setLatitude(lat);
        l.setLongitude(lon);
        return l;
    }

    public static Geofence createGeofence(Environment e) {
